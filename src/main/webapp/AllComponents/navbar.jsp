...
<div class="container-fluid"
	style="height: 10px; background-color: #81c784"></div>
...
<div class="container-fluid p-2 bg-light">
	<div class="row">
		...
		<div class="col-md-6">
			<form class="form-inline my-2 m  y-lg-0" action="search.jsp"  method="post">
		...
		<c:if test="${not empty userobj }">
			<div class="col-md-3">
			<a href="checkout.jsp" class="mt-2"><i class="fa-solid fa-cart-plus mt-2"></i>Cart</a>
		...
		<c:if test="${empty userobj}">
			<div class="col-md-3">
				...
				<a href="login.jsp" class="btn btn-success"><i
					class="fa-solid fa-right-to-bracket mr-2"></i>Login</a> <a
